...
const url = 'https://mern-blog-backend-thjw.onrender.com/api'
...
export const getAllPosts = (param) =>{
     try {
         
          return axios.get(`${url}/posts/${param}`)
     } catch (error) {
          console.log(error)
     }
}
...
export const updatePost = (id,post) =>{
     try {
          ...
          return axios.post(`${url}/update/${id}`,post)
     } catch (error) {
          console.log(error)
     }
}
